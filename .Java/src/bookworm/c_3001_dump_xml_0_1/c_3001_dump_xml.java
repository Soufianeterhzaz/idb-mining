...
public class c_3001_dump_xml implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (deploy_home != null) {
				...
				this.setProperty("deploy_home", deploy_home.toString());

			}

			if (repository_home != null) {

				this.setProperty("repository_home", repository_home.toString());

			}

		}

		public String deploy_home;

		public String getDeploy_home() {
			return this.deploy_home;
		}

		public String repository_home;

		public String getRepository_home() {
			return this.repository_home;
		}
	}
	...
	public void tSQLiteOutput_1_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tMongoDBInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String tableName_tSQLiteOutput_1 = "IDB_CRAWLER_TEST";
				boolean whetherReject_tSQLiteOutput_1 = false;

				java.sql.Connection conn_tSQLiteOutput_1 = null;
				java.lang.Class.forName("org.sqlite.JDBC");
				String url_tSQLiteOutput_1 = "jdbc:sqlite:" + "/"
						+ context.deploy_home + "/dropbox/idb-test.sqlite";
				conn_tSQLiteOutput_1 = java.sql.DriverManager
						.getConnection(url_tSQLiteOutput_1);
				conn_tSQLiteOutput_1.setAutoCommit(false);
				int commitEvery_tSQLiteOutput_1 = 10000;
				int commitCounter_tSQLiteOutput_1 = 0;

				java.sql.DatabaseMetaData dbMetaData_tSQLiteOutput_1 = conn_tSQLiteOutput_1
						.getMetaData();
				java.sql.ResultSet rsTable_tSQLiteOutput_1 = dbMetaData_tSQLiteOutput_1
						.getTables(null, null, null, new String[] { "TABLE" });
				boolean whetherExist_tSQLiteOutput_1 = false;
				while (rsTable_tSQLiteOutput_1.next()) {
					String table_tSQLiteOutput_1 = rsTable_tSQLiteOutput_1
							.getString("TABLE_NAME");
					if (table_tSQLiteOutput_1
							.equalsIgnoreCase("IDB_CRAWLER_TEST")) {
				...
				if (!whetherExist_tSQLiteOutput_1) {
					java.sql.Statement stmtCreate_tSQLiteOutput_1 = conn_tSQLiteOutput_1
							.createStatement();
					stmtCreate_tSQLiteOutput_1
							.execute("CREATE TABLE \""
									+ tableName_tSQLiteOutput_1
									+ "\"(\"url\" VARCHAR(0)  ,\"author\" VARCHAR(0)  ,\"title\" VARCHAR(0)  ,\"description\" VARCHAR(0)  ,\"comments\" VARCHAR(0)  ,\"data\" VARCHAR(0)   not null ,\"autore\" VARCHAR(0)   not null )");
				}
				String insert_tSQLiteOutput_1 = "INSERT INTO \""
						+ "IDB_CRAWLER_TEST"
						+ "\" (\"url\",\"author\",\"title\",\"description\",\"comments\",\"data\",\"autore\") VALUES (?,?,?,?,?,?,?)";
				java.sql.PreparedStatement pstmt_tSQLiteOutput_1 = conn_tSQLiteOutput_1
						.prepareStatement(insert_tSQLiteOutput_1);
				...
				if (execStat) {
					java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap_row6 = (java.util.concurrent.ConcurrentHashMap) globalMap
							.get("concurrentHashMap");
					concurrentHashMap_row6.putIfAbsent("row6" + iterateLoop,
							new java.util.concurrent.atomic.AtomicInteger(0));
				...
				if (execStat) {
					java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap_g = (java.util.concurrent.ConcurrentHashMap) globalMap
							.get("concurrentHashMap");
					concurrentHashMap_g.putIfAbsent("g" + iterateLoop,
							new java.util.concurrent.atomic.AtomicInteger(0));
				...
				if (execStat) {
					java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap_row5 = (java.util.concurrent.ConcurrentHashMap) globalMap
							.get("concurrentHashMap");
					concurrentHashMap_row5.putIfAbsent("row5" + iterateLoop,
							new java.util.concurrent.atomic.AtomicInteger(0));
				...
				try {
					...
					while (cursor_tMongoDBInput_2.hasNext()) {
						...
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
								.getValue(pathMap_tMongoDBInput_2.get("url"),
						...
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
								.getValue(
										pathMap_tMongoDBInput_2.get("author"),
										"author", o_tMongoDBInput_2);
						if (valueObj_tMongoDBInput_2 != null
								&& valueObj_tMongoDBInput_2.toString().length() > 0) {
							row5.author = valueObj_tMongoDBInput_2.toString();
						} else {
							row5.author = null;
						}
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
								.getValue(pathMap_tMongoDBInput_2.get("title"),
										"title", o_tMongoDBInput_2);
						if (valueObj_tMongoDBInput_2 != null
								&& valueObj_tMongoDBInput_2.toString().length() > 0) {
							row5.title = valueObj_tMongoDBInput_2.toString();
						} else {
							row5.title = null;
						}
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
						...
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
								.getValue(
										pathMap_tMongoDBInput_2.get("comments"),
										"comments", o_tMongoDBInput_2);
						if (valueObj_tMongoDBInput_2 != null
								&& valueObj_tMongoDBInput_2.toString().length() > 0) {
							row5.comments = valueObj_tMongoDBInput_2.toString();
						} else {
							row5.comments = null;
						}
								...
								if (dateparse != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(
												"dateparse" + iterateId, 1, 1);
									}

									whetherReject_tSQLiteOutput_1 = false;
									if (dateparse.url == null) {
										pstmt_tSQLiteOutput_1.setNull(1,
												java.sql.Types.VARCHAR);
									} else {
										pstmt_tSQLiteOutput_1.setString(1,
												dateparse.url);
									}

									if (dateparse.author == null) {
										pstmt_tSQLiteOutput_1.setNull(2,
												java.sql.Types.VARCHAR);
									} else {
										pstmt_tSQLiteOutput_1.setString(2,
												dateparse.author);
									}

									if (dateparse.title == null) {
										pstmt_tSQLiteOutput_1.setNull(3,
												java.sql.Types.VARCHAR);
									} else {
										pstmt_tSQLiteOutput_1.setString(3,
												dateparse.title);
									}

									if (dateparse.description == null) {
										pstmt_tSQLiteOutput_1.setNull(4,
												java.sql.Types.VARCHAR);
									} else {
										pstmt_tSQLiteOutput_1.setString(4,
												dateparse.description);
									}

									if (dateparse.comments == null) {
										pstmt_tSQLiteOutput_1.setNull(5,
												java.sql.Types.VARCHAR);
									} else {
										pstmt_tSQLiteOutput_1.setString(5,
												dateparse.comments);
									}

									if (dateparse.data == null) {
										pstmt_tSQLiteOutput_1.setNull(6,
												java.sql.Types.VARCHAR);
									} else {
										pstmt_tSQLiteOutput_1.setString(6,
												dateparse.data);
									}

									if (dateparse.autore == null) {
										pstmt_tSQLiteOutput_1.setNull(7,
												java.sql.Types.VARCHAR);
									} else {
										pstmt_tSQLiteOutput_1.setString(7,
												dateparse.autore);
									}

									try {
										insertedCount_tSQLiteOutput_1 = insertedCount_tSQLiteOutput_1
												+ pstmt_tSQLiteOutput_1
														.executeUpdate();
										nb_line_tSQLiteOutput_1++;
									} catch (java.lang.Exception e) {
										whetherReject_tSQLiteOutput_1 = true;
				...
				nb_line_deleted_tSQLiteOutput_1 = nb_line_deleted_tSQLiteOutput_1
						+ deletedCount_tSQLiteOutput_1;
				nb_line_update_tSQLiteOutput_1 = nb_line_update_tSQLiteOutput_1
						+ updatedCount_tSQLiteOutput_1;
				nb_line_inserted_tSQLiteOutput_1 = nb_line_inserted_tSQLiteOutput_1
						+ insertedCount_tSQLiteOutput_1;

				globalMap.put("tSQLiteOutput_1_NB_LINE",
						nb_line_tSQLiteOutput_1);
				globalMap.put("tSQLiteOutput_1_NB_LINE_UPDATED",
						nb_line_update_tSQLiteOutput_1);
				globalMap.put("tSQLiteOutput_1_NB_LINE_INSERTED",
						nb_line_inserted_tSQLiteOutput_1);
				globalMap.put("tSQLiteOutput_1_NB_LINE_DELETED",
						nb_line_deleted_tSQLiteOutput_1);
				if (execStat) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			context.deploy_home = (String) context.getProperty("deploy_home");
			context.repository_home = (String) context
					.getProperty("repository_home");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("deploy_home")) {
				context.deploy_home = (String) parentContextMap
						.get("deploy_home");
			}
			if (parentContextMap.containsKey("repository_home")) {
				context.repository_home = (String) parentContextMap
						.get("repository_home");
			}
		}
...
/************************************************************************************************
 * 60462 characters generated by Talend Open Studio for Big Data on the 18
 * novembre 2013 11.16.23 CET
 ************************************************************************************************/
